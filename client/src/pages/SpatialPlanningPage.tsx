    ...
    <div>
      ...
      <section className="relative min-h-96 flex items-center justify-center overflow-hidden bg-gradient-to-br from-primary/10 via-background to-accent/5 py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="font-heading text-4xl sm:text-5xl md:text-6xl font-bold text-foreground mb-6" data-testid="text-spatial-planning-heading">
              Spatial Planning Services
            </h1>
            <p className="text-lg text-muted-foreground mb-8" data-testid="text-spatial-planning-description">
              New insights into the future with geospatial data
            </p>
            <Link href="/contact">
              <Button size="lg" data-testid="button-spatial-planning-contact">
                Start Your Project
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            >
              <h2 className="font-heading text-3xl font-bold text-foreground mb-4" data-testid="text-spatial-planning-video-heading">
                Spatial Planning Solutions
              </h2>
              <p className="text-muted-foreground text-lg">
                Watch how we transform spatial planning with geospatial technology
              </p>
            </motion.div>
            <motion.div
              ...
              data-testid="video-spatial-planning"
            >
              <iframe
                width="100%"
                height="100%"
                src="https://www.youtube.com/embed/b0tQrv9A-wo?rel=0&modestbranding=1"
