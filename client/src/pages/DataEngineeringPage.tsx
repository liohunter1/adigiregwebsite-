    ...
    <div>
      ...
      <section className="relative min-h-96 flex items-center justify-center overflow-hidden bg-gradient-to-br from-primary/10 via-background to-accent/5 py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="font-heading text-4xl sm:text-5xl md:text-6xl font-bold text-foreground mb-6" data-testid="text-data-engineering-heading">
              Data Engineering Solutions
            </h1>
            <p className="text-lg text-muted-foreground mb-8" data-testid="text-data-engineering-description">
              Getting the right data flowing in the right direction
            </p>
            <Link href="/contact">
              <Button size="lg" data-testid="button-data-engineering-contact">
                Start Your Project
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            >
              <h2 className="font-heading text-3xl font-bold text-foreground mb-4" data-testid="text-data-engineering-video-heading">
                Data Engineering & GIS Technology
              </h2>
              <p className="text-muted-foreground text-lg">
                See how we transform data into actionable insights
              </p>
            </motion.div>
            <motion.div
              ...
              data-testid="video-data-engineering"
            >
              <iframe
                width="100%"
                height="100%"
                src="https://www.youtube.com/embed/WSOfEndqOMM?rel=0&modestbranding=1"
